...
void Foam::multiphaseEmulsionMix::calcAlphas()
{
    scalar level = 0.0;
    alphas_ == 0.0;
...
Foam::multiphaseEmulsionMix::multiphaseEmulsionMix
(
...
Foam::multiphaseEmulsionMix::rho() const
{
...
Foam::multiphaseEmulsionMix::rho(const label patchi) const
{
    PtrDictionary<phase>::const_iterator iter = phases_.begin();
...
Foam::tmp<Foam::scalarField>
Foam::multiphaseEmulsionMix::mu(const label patchi) const
{
    PtrDictionary<phase>::const_iterator iter = phases_.begin();
...
Foam::multiphaseEmulsionMix::muf() const
{
    PtrDictionary<phase>::const_iterator iter = phases_.begin();
...
Foam::tmp<Foam::volScalarField>
Foam::multiphaseEmulsionMix::nu() const
{
    return nu_;
}
...
Foam::tmp<Foam::scalarField>
Foam::multiphaseEmulsionMix::nu(const label patchi) const
{
...
Foam::tmp<Foam::surfaceScalarField>
Foam::multiphaseEmulsionMix::nuf() const
{
...
Foam::tmp<Foam::surfaceScalarField>
Foam::multiphaseEmulsionMix::surfaceTensionForce() const
{
...
void Foam::multiphaseEmulsionMix::correct()
{
    forAllIter(PtrDictionary<phase>, phases_, iter)
    {
        iter().correct();
...
Foam::tmp<Foam::surfaceVectorField> Foam::multiphaseEmulsionMix::nHatfv
(
...
Foam::tmp<Foam::surfaceScalarField> Foam::multiphaseEmulsionMix::nHatf
(
    const volScalarField& alpha1,
    const volScalarField& alpha2
) const
...
void Foam::multiphaseEmulsionMix::correctContactAngle
(
    const phase& alpha1,
    const phase& alpha2,
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseEmulsionMix::K
(
    const phase& alpha1,
    const phase& alpha2
) const
...
Foam::tmp<Foam::volScalarField>
Foam::multiphaseEmulsionMix::nearInterface() const
{
...
bool Foam::multiphaseEmulsionMix::read()
{
